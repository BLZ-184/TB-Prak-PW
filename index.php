    ...
    <div class="body-wrap boxed-container">
        ...
        <div class="container mt-16">
          <div class="site-header-inner">
            <div class="feature-header">
              <img
                src="https://www.itg.ac.id/mainsite/wp-content/uploads/2021/08/logo-putih-ITG-2048x2048.png"
                alt=""
                width="75"
                class="mr-16"
              />
              <h1 class="m-0">ITG Express</h1>
            </div>
          </div>
        </div>
      </header>
      ...
      <main>
            ...
            <div class="hero-inner">
              <div class="hero-copy">
                <h1 class="hero-title mt-0 is-revealing">
                  Jasa Pengiriman Paket Cepat dan Murah
                </h1>
                <p class="hero-paragraph is-revealing">
                  Kirim paket ke seluruh Indonesia dengan cepat dan murah
                  bersama ITG Express.
                </p>
                <div class="hero-form field field-grouped is-revealing">
                  ...
                  <div class="control">
                    <a class="button button-primary button-block" href="#resi"
                      >Cek Resi</a
                    >
                  </div>
                </div>
                ...
                <div class="feature">
                  <div class="feature-inner">
                    ...
                    <p class="text-sm mb-0">
                      Kami memiliki jaringan luas yang mencakup seluruh wilayah
                      Indonesia, sehingga paket Anda akan sampai ke tujuan
                ...
                <div class="feature">
                  <div class="feature-inner">
                    <div class="feature-header mb-16">
                      ...
                      <h4 class="feature-title m-0">Tarif yang terjangkau</h4>
                    </div>
                    <p class="text-sm mb-0">
                      kami juga menawarkan tarif yang terjangkau untuk semua
                      jenis paket. Jadi, Anda tidak perlu khawatir dengan biaya
                ...
                <div class="feature">
                  <div class="feature-inner">
                    <div class="feature-header mb-16">
                      ...
                      <h4 class="feature-title m-0">Layanan Maksimal</h4>
                    </div>
                    <p class="text-sm mb-2">
                      ITG Express memberikan perlindungan maksimal untuk paket
                      Anda dengan layanan asuransi.
                    </p>

                    <p class="text-sm mb-2">
                      Kami memudahkan Anda untuk mengirim paket dengan layanan
                      pick up.
                    </p>
                    <p class="text-sm mb-2">
                      Anda dapat membayar biaya pengiriman dan barang yang
                      dibeli secara langsung kepada kurir saat paket diterima
                      (COD).
                    </p>
                  </div>
                </div>
        ...
        <section class="cekresi-container">
          <div id="resi" class="container">
            <h4 class="feature-title mb-16">Cek Resi</h4>
            <table>
              <tr>
              ...
              <tr>
                <td class="text-xs text-center">01 Januari 2024 00:00</td>
                <td class="text-xs text-center"></td>
                <td class="text-xs">Nomor Resi Pengiriman telah dibuat</td>
              </tr>
              <tr>
                <td class="text-xs text-center">01 Januari 2024 02:00</td>
                <td class="text-xs text-center">[ITG Garut Hub]</td>
                <td class="text-xs">Paket anda telah diambil dari penjual</td>
              </tr>
            </table>
          </div>
        </section>
        ...
        <div class="container">
          <div class="site-footer-inner has-top-divider">
            <div class="footer-copyright">
              &copy; 2024 ITG Express, all rights reserved
            </div>
